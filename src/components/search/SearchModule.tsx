...
//  const updateSearchValue = dispatch(setSearchValue(value));    
     ...
     //        [],
     //     )
    const updateSearchValue = (event: string)=>{
          setSearchValue('')
    }  
